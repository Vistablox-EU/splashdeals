  ...
  return (
    <div className="min-h-screen pb-16 sm:pb-32 pt-24 sm:pt-32 px-6 sm:px-12 max-w-5xl mx-auto">
      ...
      <header className="mb-12 sm:mb-20 space-y-6">
        ...
        <h1 className="text-5xl sm:text-7xl font-black tracking-tighter uppercase italic leading-[0.9] text-muted-foreground/60 select-none pointer-events-none">Politika Privatnosti</h1>
