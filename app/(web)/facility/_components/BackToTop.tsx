...
export function BackToTop() {
  ...
  return (
    <Button
      ...
      size="icon"
      className={cn(
        "bg-primary text-primary-foreground hover:bg-primary/90 shadow-primary/30 fixed right-5 bottom-[calc(6rem+env(safe-area-inset-bottom,0px))] z-50 size-11 rounded-full shadow-lg transition-[opacity,transform] duration-300 active:scale-90 motion-reduce:transition-none md:bottom-8",
